...
useEffect(()=>{
  ...
  const filteredbestSalesProducts = value.docs.filter((item)=>{return item.data().category === "sofa"});
  const filteredmobileproducts = value.docs.filter((item)=>{return item.data().category === "mobile"});
  const filteredwirelessProducts = value.docs.filter((item)=>{return item.data().category === "wireless"});
  const filteredpopularProducts = value.docs.filter((item)=>{return item.data().category === "watch"});
